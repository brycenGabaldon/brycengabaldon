...
function Task2({id, title, description, completed, awaitBackground}) {
  ...
  return (
    <div className={`task ${checked && 'task--borderColor'}`} style={{background: awaitBackground, backgroundSize: "contain"}}>
      <div>
        <input 
          id={`checkbox-${id}`} 
